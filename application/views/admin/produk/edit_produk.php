					...
					<div class="span9">
						<div class=""><!-- basic tabs menu -->
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="<?php echo base_url(); ?>administrator/edit_produk/<?php echo $edit_produk->id_produk; ?>">Edit Produk</a></li>
							</ul>
						</div><!-- basic tabs menu -->
						...
						<div class="well"><!-- div well & form -->
							...
							<?php } ?>
								...
								<div class="controls">
								<input placeholder="Nama Produk" name="nama_produk" type="text" class="input" id="input01" value="<?php echo $edit_produk->nama_produk; ?>">
								<input name="id_produk" type="hidden" value="<?php echo $edit_produk->id_produk; ?>">
							...
							<?php } ?>
									...
									<div class="controls">
										...
										<textarea name="deskripsi" style="width: 440px; height:340px;" cols="20" id="some-textarea"><?php echo $edit_produk->deskripsi; ?></textarea>
								...
								<div class="control-group"><!-- select option -->
									...
									<div class="controls">
									  <select name="id_kategori" id="select01">
										<option value="<?php echo $edit_produk->id_kategori_produk; ?>"><?php echo $edit_produk->nama_kategori; ?>.</option>
